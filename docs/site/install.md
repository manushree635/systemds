...
### JAVA
1. Download the JAVA 8 from https://www.oracle.com/in/java/technologies/javase/javase-jdk8-downloads.html Mac OS version
...
3. Extract using thre below command line
